    ...
    <header className={"relative"}>
      <div className={"relative flex flex-col justify-center items-center"}>
        ...
        <div className={"mx-auto max-w-7xl"}>
          <p
            className={"tracking-wide text-justify text-gray-400/80 text-sm lg:mx-80 animate-fade-right animate-once animate-duration-[1300ms] animate-delay-0 animate-ease-linear"}>
        ...
        <div
          className={"mt-8 sm:mt-10 flex-row sm:flex justify-center space-x-6 text-sm animate-ping animate-once animate-duration-[1300ms] animate-delay-0 animate-ease-linear animate-reverse"}>
          <Link
        ...
        <div className={"my-2 w-2/4"}>
          <Carousel loop>
            {images.map((src,i)=>{
              return(
                <div key={i} className={"relative h-[32rem] flex-[0_0_100%]"}>
